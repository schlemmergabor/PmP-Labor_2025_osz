namespace L03_tombok
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i <= kartyak.Length - 1; i++)
            {
            ...
            {
                // i + 1 esetében i-nél 1-el nagyobb értéket írunk ki
                // 0-tól indul i, így lesz szép 1. szó, 2. szó...
            ...
            while (holVan == -1 && ind < szavak.Length)
            {
                ...
                // minden esetben (ha igaz volt, ha hamis volt a fenti feltétel
                // megnövelem az index változó értékét
                ind++;
            }
