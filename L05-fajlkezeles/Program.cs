...
namespace L05_fajlkezeles
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // addig ismétlünk, amíg a válasz "Y"
            string valasz = "";
            do
            {
                // kihúzott számok
                ...
                while (huzasok < 5)
                {
                    ...
                    // ez kell ahhoz, hogy különböző 5 számunk legyen
            ...
            // kiírás
            // nullával osztás miatt hiba lehet, ezért erre figyelünk!
            double avgFFI = 0.0;
            double avgNOI = 0.0;
            
            if (numFFI != 0) avgFFI = sumFFI / numFFI;
            
            if (numNOI != 0) avgNOI = sumNOI / numNOI;

            // kiírjuk a várt szöveget

            Console.WriteLine($"A {felmeres} időszakban a férfiak átlagos BMI-je: {avgFFI}, a hölgyek átlagos BMI-je: {avgNOI}.");
            ...
            // kiírás, osztás miatt lehet, hogy 0 ellenőrzés jó lenne...
            ...
            // osztás miatt itt is egy 0 ellenőrzés jó lenne...
